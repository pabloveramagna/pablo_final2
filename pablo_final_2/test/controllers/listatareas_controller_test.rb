...
class ListatareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create listatarea" do
    assert_difference('Listatarea.count') do
      post listatareas_url, params: { listatarea: { dede: @listatarea.dede, hasta: @listatarea.hasta, nombre: @listatarea.nombre, realizado: @listatarea.realizado, responsable: @listatarea.responsable } }
    end
  ...
  test "should update listatarea" do
    patch listatarea_url(@listatarea), params: { listatarea: { dede: @listatarea.dede, hasta: @listatarea.hasta, nombre: @listatarea.nombre, realizado: @listatarea.realizado, responsable: @listatarea.responsable } }
